...
const Cafenespreso = () => {
  ...
  const mocktails = [
    { name: 'Forte', desc: "malte et fruit 7 / 2", price: '500 DA' },
    { name: 'Intenso', desc: "intense 12 / 12", price: '500 DA' },
    { name: 'Ristretto', desc: 'intense et boise 9 / 12', price: '500 DA' },
    { name: 'Leggero', desc: "cereales grillees 6 / 12", price: '500 DA' },
    { name: 'Guatemala', desc: "xereales maltees 6 / 12", price: '500 DA' },
    { name: 'Brazil', desc: "doux et grille 4 / 12", price: '500 DA' },
    { name: 'Vanilio',  price: '500 DA' },
    { name: 'Caramello',  price: '500 DA' },
    { name: 'Decaffeinato',  price: '500 DA' },
  ]
