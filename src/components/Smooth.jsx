...
const Smooth = () => {
  ...
  const mocktails = [
    { name: 'Smoothie banane-fraise',  price: '850 DA' },
    { name: 'Smoothie mangue-peche...',  price: '850 DA' },
    { name: 'Smoothie cerise-ananas', price: '850 DA' },
    { name: 'Smoothie healthy',  price: '900 DA' },
