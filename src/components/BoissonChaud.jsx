...
const BoissonChaud = () => {
  ...
  const mocktails = [
    { name: 'Evebot photo',  price: '600 DA' },
    { name: 'cappuccino',  price: '550 DA' },
    { name: 'Mocha ', price: '600 DA' },
    { name: 'Latte machiato(c,v,n)',  price: '600 DA' },
    { name: 'Ice spanish latte',  price: '600 DA' },
     { name: 'Latte machiati glace (c,v,n)...',  price: '600 DA' },
     { name: 'Caffe latte ',  price: '600 DA' },
     { name: 'The maison',  price: '400 DA' },
     { name: 'Chocolat chaud',  price: '700 DA' },
