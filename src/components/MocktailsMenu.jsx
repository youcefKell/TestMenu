...
const MocktailsMenu = () => {
  ...
  const mocktails = [
    { name: 'Pina colada', desc: "coco, jus d'ananas, citron", price: '850 DA' },
    { name: 'Bora bora', desc: "grenadine, jus d'ananas, frais de passion, citron", price: '850 DA' },
    { name: 'Bleu lagon', desc: 'bleu curacao, ananas, citron, Sprite', price: '850 DA' },
    { name: 'Cherry blossom', desc: "purée cerise, purée litchi, citron, jus d'ananas, Sprite", price: '850 DA' },
    { name: 'Paradise reef', desc: "purée tropical, jus d'ananas, bleu curacao", price: '850 DA' },
  ]
